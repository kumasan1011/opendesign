...
leds_pos[1] = [-0.3, 0.1, 0.1];
leds_pos[2] = [-0.15, -0.14, 0.1];
leds_pos[3] = [0.37, -0.13, 0.1];
leds_pos[4] = [-0.04, 0.25, 0.1];
leds_pos[5] = [-0.04, -0.2, 0.1];
leds_pos[6] = [0.1, -0.1, 0.1];
...
function r_lightsdata(data) {
    ...
    //                     leds[i].position.set(leds_pos[0][i], leds_pos[1][i], leds_pos[2][i]);
    //                 }else{
    //                     scene.remove(leds[i]);
    //                 }
    //             }
    ...
    // // lights_data = JSON.parse(data);
    // if(closeだったら) {
    //     for(var i = 0; i < LEDNUM; i++) {
    //         if(lights_data[i][id] == closeのid){
    //             lights_data[i] = {
    //                 id: -1,
    //                 state: false,
    //                 color: 0xffffff
    ...
    //     }
    // }
    // if(open closeじゃなかったら) {
    //     for(var i = 0; i < data.length; i++){
    //         for(var j = 0; j < LEDNUM; j++) {
    //             if(lights_data[j][id] == data[i][id]) {
    //                 lights_data[j] = data[i];
    //             }
    //         }
    //     }
    // }
